...
install() {
echo -e "\033[0;36m"
echo -e "~ Welcome To Source Carlos - اهلا بك في سورس كارلوس ~"
...
wget "api-dragon.tk/installubuntu18/compat-libevent2-5_2.0.21-1ubuntu18_amd64.deb" && sudo dpkg -i compat-libevent2-5_2.0.21-1ubuntu18_amd64.deb
...
echo -e "\033[0;36m"
echo -e "' ' ' ' ' ' ' ' ' ' ' ' ' ' ' ' ' ' ' ' ' ' ' ' ' ' ' '  ' ' ' ' '"
echo -e "'      _______  _______  _______  _        _______  _______      '"
echo -e "'     (  ____ \(  ___  )(  ____ )( \      (  ___  )(  ____ \     '"
echo -e "'     | (    \/| (   ) || (    )|| (      | (   ) || (    \/     '"
echo -e "'     | |      | (___) || (____)|| |      | |   | || (_____      '"
echo -e "'     | |      |  ___  ||     __)| |      | |   | |(_____  )     '"
echo -e "'     | |      | (   ) || (\ (   | |      | |   | |      ) |     '"
echo -e "'     | (____/\| )   ( || ) \ \__| (____/\| (___) |/\____) |     '"
echo -e "'     (_______/|/     \||/   \__/(_______/(_______)\_______)     '"
echo -e "' ' ' ' ' ' ' ' ' ' ' ' ' ' ' ' ' ' ' ' ' ' ' ' ' ' ' '  ' ' ' ' '"
echo -e "\033[0m"
